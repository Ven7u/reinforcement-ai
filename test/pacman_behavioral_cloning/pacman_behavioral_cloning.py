...
# Slides and code for the tutorial here (https://goo.gl/X4ULZc ) and here (https://github.com/MadcowD/tensorgym).
###
...
def create_model():
    ...
    with tf.variable_scope("layer1"):
        hidden = tf.layers.dense(state_ph, 512, activation=tf.nn.relu)
